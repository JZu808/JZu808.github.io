...
<img width="500px" class="rounded float-start pe-4" src="../img/TypescriptPlayground.png">

## First Impressions of TypeScript
As an electrical engineering student, my coursework has taken me through several programming languages, mostly Python and C/C++. When I started ICS 314, I expected to be using a difficult language like Java. I'd used Java back in ICS 111 during my first year of community college, and it had been a hard language for me at the time, so I was extremely afraid about facing it again. As it turned out, we were learning something new instead: TypeScript.

Learning Java traumatized me, so I really hoped that Typescript was not going to give me even more trauma. Before getting to TypeScript, we had to cover the basics of JavaScript. I was already somewhat familiar with it, having learned a bit about seven years ago in high school, though I hadn't touched it since. Coming back to it, both JavaScript and TypeScript were surprisingly not that bad. The syntax felt straightforward, and it was easier to memorize. It was a nice contrast to the steep learning curve I remembered from Java.
